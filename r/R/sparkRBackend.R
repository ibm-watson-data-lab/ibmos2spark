...
######################################################################################################
######################################################################################################
# This code is borrowed by permission from the SparkR package and can be found at
# https://github.com/amplab-extras/SparkR-pkg/blob/9694d8e0148879e51fb7610deb8028dfe00aaffb/pkg/R/sparkRBackend.R
# it will be replaced in this package with SparkR dependency when SparkR is added to mainstream repository
######################################################################################################
######################################################################################################
######################################################################################################
######################################################################################################
